 ...
 * @Entity
 * 
 * @Table(name = "user_order") public class Order implements Serializable{
 * 
 ...
 * orderDate; private Date shippingDate; private String shippingMethod; private
 * String orderStatus; private BigDecimal orderTotal;
 * 
 * @OneToMany(mappedBy = "order", cascade=CascadeType.ALL) private
 * List<CartItem> cartItemList;
 * 
 * @OneToOne(cascade=CascadeType.ALL) private UserShipping shippingAddress;
 * 
 * @OneToOne(cascade=CascadeType.ALL) private UserBilling billingAddress;
 * 
 * @OneToOne(cascade=CascadeType.ALL) private UserPayment payment;
 * 
 * @ManyToOne
 * 
 ...
 * 
 * public void setShippingMethod(String shippingMethod) { this.shippingMethod =
 * shippingMethod; }
 * 
 ...
 * 
 * public void setOrderTotal(BigDecimal orderTotal) { this.orderTotal =
 * orderTotal; }
 * 
 * public List<CartItem> getCartItemList() { return cartItemList; }
 * 
 * public void setCartItemList(List<CartItem> cartItemList) { this.cartItemList
 * = cartItemList; }
 * 
 * public UserShipping getShippingAddress() { return shippingAddress; }
 * 
 * public void setShippingAddress(UserShipping shippingAddress) {
 * this.shippingAddress = shippingAddress; }
 * 
 * public UserBilling getBillingAddress() { return billingAddress; }
 * 
 ...
 * 
 * public void setPayment(UserPayment payment) { this.payment = payment; }
 * 
